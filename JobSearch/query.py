...
def generate_response(prompt,similar_jobs):
    ...
    context_template = read_markdown_file('JobSearch/context_template.md')
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
             {
            "role": "system",
            "content": "You are a conversational assistant who helps users with their job search. Your main tasks include providing the top 5 job listings relevant to the user's query and answering any questions related to these listings."
            },
            {
                "role": "user",
                "content": context
